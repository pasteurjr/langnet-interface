...
interface DataModelHistoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const DataModelHistoryModal: React.FC<DataModelHistoryModalProps> = ({
  isOpen,
  onClose,
  sessionId,
  currentVersion,
  ...
  const loadVersions = useCallback(async () => {
    ...
    setError(null);
    try {
      const response = await fetch(`${API_BASE}/data-model/${sessionId}/versions`, {
        method: "GET",
      ...
      console.error("Error loading data-model versions:", err);
    ...
    <div className="modal-overlay">
      <div className="history-modal">
        <div className="modal-header">
          <h2>📜 Histórico de Versões — Modelo de Dados</h2>
          ...
          {!loading && !error && versions.length === 0 && (
            <div className="empty-state">
              ...
              <p className="empty-hint">
                As versões do modelo de dados aparecerão aqui
              </p>
            </div>
          )}
...
export default DataModelHistoryModal;
