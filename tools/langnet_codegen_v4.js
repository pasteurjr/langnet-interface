...
const AGENTS='bcab893b-'; const TASKS='8ef50b04-'; const ATS='bf41c118-'; const PORT='5027';
...
(async()=>{
  ...
  await p.screenshot({path:`${OUT}/50-codegen-modal.png`,fullPage:true});
  ...
  await sleep(3000);
  await p.screenshot({path:`${OUT}/51-codegen-done.png`,fullPage:true});
