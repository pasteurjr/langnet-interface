...
from app.routers.ui_spec import router as ui_spec_router
...
app.include_router(data_model_router)  # Data Model generation from specification (prefix already includes /api/data-model)
app.include_router(ui_spec_router)  # UI Spec & Prototype (prefix already includes /api/ui-spec)
