...
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | O atendente acessa a tela de cadastro. | Sistema exibe a tela "Cadastro de Pacientes" com tabela de pacientes e formulário para preenchimento (nome, CPF, data de nascimento etc.). |
...
| Nome             | CPF                | Data de Nascimento | Contato            | Convênio         | Ações            |
| ...              | ...                | ...                | ...                | ...              | Ver Editar Excluir |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista preenche queixa inicial e sinais vitais. | Sistema registra os dados fornecidos pelo atendente/recepcionista.                                |
| 2  | Agente Hub de Triagem classifica urgência usando protocolo Manchester. | Sistema calcula a classificação (verde/amarelo/vermelho) e justificativa.                 |
...
│                                                      │
│  AÇÃO EXPLÍCITA                                      │
│    [Classificar com IA (Executado pelo Agente Hub de Triagem)] |
│                                                      │
│  RESULTADO DO AGENTE                                 │
│    Classificação: Verde                              │
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Especialista recebe paciente.     | Sistema exibe roteiro de perguntas específico para a especialidade e campos para preenchimento das respostas do paciente.                                    |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Especialista preenche os campos de entrada. | Sistema exibe a interface com os dados do paciente e permite o agente especialista ajustar as informações se necessário. |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente de Registro preencher os dados da triagem, pré-diagnóstico e encaminhamento no prontuário. | Sistema registra os dados no prontuário do paciente e gera resumo para o médico. |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista acessa tela de consentimento. | Sistema exibe tela "Consentimentos" com lista de pacientes e opções para cadastrar novo consentimento.      |
| 2  | Recepcionista seleciona paciente ou clica em [+ Novo] para cadastrar um novo consentimento. | Sistema exibe o formulário de cadastro/edição do consentimento.                                    |
...
```
Busca: [__________]  [+ Novo]
| Paciente   | Data/Hora       | Versão Termo | Ações            |
| ...        | ...             | ...          | Ver Editar Excluir |
...
│    [Justificativa informada]                         │
│                                                      │
│  Executado pelo Agente Hub de Triagem                │
│                                                      │
│  Classificação: Verde                                │
│  Justificativa: Paciente está em condições estáveis. │
│  Área de destino: Consultório Gastroenterologia      │
│                                                      │
│  ┌──────────────────┐  ┌─────────────────┐           │
│  │ Encaminhar ao    │  │   Cancelar        │           │
│  │ Especialista     │  └─────────────────┘           │
...
--- Formulário ---
Nome: [______________]  CRM: [_____]   Especialidade: [________________]
[Salvar] [Cancelar]
```
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista acessa tela de gestão de atendimentos. | Sistema exibe tela "Gestão de Atendimentos" com lista de atendimentos em diferentes status (aberto, em_triagem, aguardando_especialista, encaminhado, concluído, cancelado) e ações por linha para cada registro. |
| 2  | Recepcionista seleciona ação desejada (Ver/Editar/Excluir) para um atendimento específico. | Sistema apresenta formulário correspondente à ação selecionada (visualização, edição ou confirmação de exclusão). |
| 3  | Recepcionista preenche os dados necessários e clica em "Salvar". | Sistema registra as alterações no banco de dados e exibe mensagem de sucesso.             |
...
```
Busca: [__________]  [+ Novo]
| Paciente   | Data/Hora      | Status                | Ações            |
| Paciente A | 10/05/2023 14:00 | aberto              | Ver Editar Excluir |
| Paciente B | 10/05/2023 15:00 | em_triagem          | Ver Editar Excluir |
--- Formulário ---
Paciente: [____]  
Data/Hora: [____] 
Status: [Selecionar]
...
| 2  | Agente Especialista seleciona ação desejada (Ver/Editar/Excluir) para um pré-diagnóstico específico. | Sistema apresenta formulário correspondente à ação selecionada (visualização, edição ou confirmação de exclusão). |
...
```
Busca: [__________]  [+ Novo]
| Atendimento | Paciente | Hipóteses          | Ações            |
| ...         | ...      | ...                | Ver Editar Excluir |
...
```
Busca: [__________]  [+ Novo]
| Atendimento | Especialidade | Médico | Prioridade | Ações            |
| ...         | ...           | ...    | ...        | Ver Editar Excluir |

--- Formulário ---
Atendimento: [____]  Especialidade: [____]   Médico: [____]
Prioridade: [____]   Motivo do Encaminhamento: [___________________________________________]
[Salvar] [Cancelar]
```
...
--- Formulário ---
Nome: [____]  Sobrenome: [____]  CPF: [____]   [Salvar] [Cancelar]

Fila de Triagem:
| Paciente | Urgência | Área de Destino |
| -------- | -------- | --------------- |
| Paciente A | Verde    | Sala de Espera  |
| Paciente B | Amarelo  | Consultório     |
| Paciente C | Vermelho | Pronto-Socorro  |
...
--- ENTRADA ---
Queixa Original: [Paciente relatou dor abdominal intensa]
...
--- RESULTADO DO AGENTE ---
Executado pelo Agente Hub de Triagem
Classificação de Urgência: Vermelho
Área de Destino: Pronto-Socorro/Emergência
...
1. Durante quanto tempo você tem dor? [Há dois dias]
2. Você já tomou medicamento para isso? [Sim, paracetamol]
...
Busca: [__________]  [+ Novo]
| Paciente | Especialidade | Médico          | Prioridade | Status     | Ações            |
| -------- | ------------- | --------------- | ---------- | ---------- | ---------------- |
| Maria Santos | Cardiologia   | Dr. João Silva  | Alta       | Confirmado | Ver Editar Excluir |

--- Formulário ---
Paciente: [____]  Especialidade: [____]  Médico: [____]  Prioridade: [____]  Status: [____]   [Salvar] [Cancelar]
