...
| Campo                | Detalhe                                                                 |
|----------------------|-------------------------------------------------------------------------|
| **Ator Principal**   | Recepcionista/Atendente                                                 |
...
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | O atendente acessa a tela de cadastro. | Sistema exibe a tela "Cadastro de Pacientes" com campos para preenchimento (nome, CPF, data de nascimento etc.). |
| 2  | O atendente preenche todos os dados do paciente e clica em "Salvar". | Sistema valida os dados, grava no banco de dados e exibe mensagem "Paciente cadastrado com sucesso!". |

#### Fluxos Alternativos

| ID | Condição                                     | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------------|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| A1 | O CPF informado já está registrado no sistema. | O atendente preenche os dados novamente. | Sistema exibe mensagem "CPF já cadastrado, tente outro CPF ou procure o paciente existente."              |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Hub recebe queixa inicial e sinais vitais. | Sistema registra os dados fornecidos pelo atendente/recepcionista.                                |
| 2  | Agente Hub classifica urgência usando protocolo Manchester. | Sistema calcula a classificação (verde/amarelo/vermelho) e justificativa.                 |
| 3  | Se vermelho: sistema desvia para Pronto-Socorro. | Sistema exibe mensagem "Paciente deve ser encaminhado ao Pronto-Socorro imediatamente."            |
| 4  | Se amarelo/verde: sistema roteia para especialidade correspondente. | Sistema encontra agente especialista disponível e inicia pré-atendimento.                |

#### Fluxos Alternativos

| ID | Condição                                     | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------------|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| A1 | Sinais vitais ausentes; triagem continua com queixa em texto livre. | Agente Hub classifica urgência apenas com base na queixa. | Sistema calcula a classificação e justificativa sem sinais vitais.                                      |
...
│                                                      │
│  Classificação: Verde                                │
│  Justificativa: Paciente com queixa leve e sinais vitais normais. |
│                                                      │
│  ┌──────────────────┐  ┌─────────────────┐           │
│  │     Confirmar    │  │    Cancelar     │           │
│  └──────────────────┘  └─────────────────┘           │
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Especialista recebe paciente.     | Sistema exibe roteiro de perguntas específico para a especialidade.                                    |
| 2  | Agente Especialista conduz o roteiro de perguntas ao paciente. | Sistema registra as respostas fornecidas pelo paciente.                                        |
| 3  | Agente Especialista gera pré-diagnóstico com hipóteses, nível de confiança e recomendação de exames. | Sistema registra o pré-diagnóstico no banco de dados e exibe na tela "Pré-Diagnóstico Gerado". |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Especialista gera pré-diagnóstico com hipóteses, nível de confiança e recomendação de exames. | Sistema registra o pré-diagnóstico no banco de dados e exibe na tela "Pré-Diagnóstico Gerado". |
| 2  | Pré-diagnóstico gerado é associado ao paciente e atendimento correspondente. | Sistema vincula o pré-diagnóstico à triagem e histórico do paciente.                                    |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente de Encaminhamento consulta a disponibilidade dos médicos da especialidade. | Sistema busca médicos disponíveis e exibe lista na tela "Seleção de Médico".     |
...
| 3  | Encaminhamento gerado é vinculado ao paciente, atendimento e pré-diagnóstico. | Sistema salva o encaminhamento no banco de dados e notifica recepção.           |
...
│                                                      │
│  Médicos Disponíveis:                                │
│    - Dr. João Silva (14h às 15h)                     │
│    - Dra. Maria Oliveira (16h às 17h)                │
│                                                      │
│  Selecione um médico para encaminhar o paciente:     │
│  [Selecione um médico...]                            │
│                                                      │
│  ┌──────────────────┐  ┌─────────────────┐           │
│  │    Encaminhar    │  │    Cancelar     │           │
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente de Registro consolidar triagem, pré-diagnóstico e encaminhamento no prontuário. | Sistema registra os dados no prontuário do paciente e gera resumo para o médico. |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Médico visualiza o resumo do Agente de Registro. | Sistema exibe tela "Resumo do Pré-Diagnóstico" com informações consolidadas.                             |
| 2  | Médico valida ou refuta hipóteses apresentadas no pré-diagnóstico. | Sistema registra a validação/refutação das hipóteses.                                                |
| 3  | Médico registra diagnóstico final, conduta e prescrição para o paciente. | Sistema salva as informações no prontuário do paciente.                                            |
| 4  | Médico encerra o atendimento e associa ao CRM do médico responsável. | Sistema registra a conclusão da consulta no banco de dados e notifica recepção.               |

#### Fluxos Alternativos

| ID | Condição                                     | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------------|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| A1 | Médico solicita exames adicionais.           | Médico registra novos exames no prontuário. | Sistema salva os novos exames e atualiza o resumo para a próxima consulta.                             |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista acessa tela de consentimento. | Sistema exibe tela "Consentimento para Tratamento de Dados" com termos e condições.                       |
| 2  | Paciente lê os termos e clica em "Concordo". | Sistema registra o consentimento do paciente no prontuário, incluindo data/hora e versão do termo.     |
| 3  | Recepcionista confirma o registro do consentimento. | Sistema exibe mensagem "Consentimento registrado com sucesso!" e grava dados no banco de dados. |
...
**Tela:** Consentimento para Tratamento de Dados
...
│    1. Coletar queixa inicial e sinais vitais         │
│    2. Classificar urgência manualmente               │
│    3. Roteirizar para especialidade correspondente   │
│                                                      │
│  Responsáveis pelas etapas:                          │
│    - Recepcionista: Passos 1 e 2                     │
│    - Administrador: Passo 3                          │
│                                                      │
...
| 2  | Administrador seleciona ação desejada (Cadastrar/Editar/Excluir) para um agente específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Administrador acessa tela de gestão de especialidades. | Sistema exibe tela "Gestão de Especialidades" com lista de especialidades ativas e inativas.    |
| 2  | Administrador seleciona ação desejada (Cadastrar/Editar/Excluir) para uma especialidade específica. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
| 3  | Administrador preenche os dados necessários e clica em "Salvar". | Sistema registra as alterações no banco de dados e exibe mensagem de sucesso.             |
...
| 2  | Administrador seleciona ação desejada (Cadastrar/Editar/Excluir) para um médico específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
| 3  | Administrador preenche os dados necessários e clica em "Salvar". | Sistema registra as alterações no banco de dados e exibe mensagem de sucesso.             |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista acessa tela de gestão de pacientes. | Sistema exibe tela "Gestão de Pacientes" com lista de pacientes ativos e inativos.                       |
| 2  | Recepcionista seleciona ação desejada (Cadastrar/Editar/Excluir) para um paciente específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Recepcionista acessa tela de gestão de atendimentos. | Sistema exibe tela "Gestão de Atendimentos" com lista de atendimentos em diferentes status (aberto, em_triagem, aguardando_especialista, encaminhado, concluído, cancelado). |
| 2  | Recepcionista seleciona ação desejada (Cadastrar/Editar/Excluir) para um atendimento específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
| 3  | Recepcionista preenche os dados necessários e clica em "Salvar". | Sistema registra as alterações no banco de dados e exibe mensagem de sucesso.             |
...
│    - Paciente A (Status: aberto)                     │
│    - Paciente B (Status: em_triagem)                 │
│                                                      │
│  Ações Disponíveis:                                  │
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente Especialista acessa tela de gestão de pré-diagnósticos. | Sistema exibe tela "Gestão de Pré-Diagnósticos" com lista de pré-diagnósticos associados a atendimentos. |
| 2  | Agente Especialista seleciona ação desejada (Cadastrar/Editar/Excluir) para um pré-diagnóstico específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
| 3  | Agente Especialista preenche os dados necessários e clica em "Salvar". | Sistema registra as alterações no banco de dados e exibe mensagem de sucesso.             |

#### Fluxos Alternativos

| ID | Condição                                     | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------------|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| A1 | Agente Especialista solicita exclusão de um pré-diagnóstico associado a atendimento em status concluído. | Sistema exibe mensagem confirmando a exclusão e solicitando justificativa. | Sistema registra a exclusão lógica do pré-diagnóstico no banco de dados e notifica agente sobre conclusão da operação. |
| A2 | Agente Especialista edita as hipóteses de um pré-diagnóstico existente. | Sistema valida as alterações e registra novos parâmetros do pré-diagnóstico. | Sistema salva as alterações no banco de dados e exibe mensagem de sucesso.                             |
...
├──────────────────────────────────────────────────────┤
│                                                      │
│  Lista de Pré-Diagnósticos:                          │
│    - Atendimento A (Paciente X)                      │
│    - Atendimento B (Paciente Y)                      │
│                                                      │
│  Ações Disponíveis:                                  │
│    [Cadastrar Novo Pré-Diagnóstico]                  │
│    [Editar Pré-Diagnóstico Existente]                │
│    [Excluir Pré-Diagnóstico]                         │
│                                                      │
│  ┌──────────────────┐                                │
│  │     Selecionar     │                                │
│  └──────────────────┘                                │
...
| #  | Ação do Ator                           | Resposta do Sistema                                                                                      |
|----|----------------------------------------|--------------------------------------------------------------------------------------------------------|
| 1  | Agente de Encaminhamento acessa tela de gestão de encaminhamentos. | Sistema exibe tela "Gestão de Encaminhamentos" com lista de encaminhamentos associados a atendimentos. |
| 2  | Agente de Encaminhamento seleciona ação desejada (Cadastrar/Editar/Excluir) para um encaminhamento específico. | Sistema apresenta formulário correspondente à ação selecionada (cadastro, edição ou confirmação de exclusão). |
...
**Tela:** Gestão de Encaminhamentos
...
│    - Atendimento A (Especialidade X, Médico Y)       │
│    - Atendimento B (Especialidade Z, Médico W)       │
│                                                      │
│  Ações Disponíveis:                                  │
...
#### Tela de Recepção
**Descrição:** Interface para cadastro/edição de pacientes, abertura de atendimentos e acompanhamento da fila de triagem.
...
│                                             │
│  Fila de Triagem:                           │
│    - Paciente A (Urgência: Verde)             │
│    - Paciente B (Urgência: Amarelo)           │
│    - Paciente C (Urgência: Vermelho)          │
│                                             │
└─────────────────────────────────────────────┘
```

#### Tela de Triagem Agentiva
**Descrição:** Exibe recebimento da queixa pelo agente-hub, classificação de urgência e área de destino.
...
│                                             │
│  Queixa Original:                           │
│    Paciente relatou dor abdominal intensa     │
...
│                                             │
│  Roteiro de Perguntas:                      │
│    1. Durante quanto tempo você tem dor?     │
│    2. Você já tomou medicamento para isso?   │
│                                             │
│  Respostas do Paciente:                     │
│    1. Há dois dias                         │
│    2. Sim, paracetamol                       │
│                                             │
│  Pré-diagnóstico:                           │
│    Hipóteses: Apendicite                    │
│    Confiança: Média                         │
│    Exames Sugeridos: TC Abdominal           │
│                                             │
└─────────────────────────────────────────────┘
```

#### Tela de Encaminhamentos
...
│                                             │
│  Histórico:                                 │
│    Atendimento A (10/08/2026):              │
│      Queixa: Dor abdominal intensa          │
│      Classificação: Vermelho                │
│      Pré-diagnóstico: Apendicite            │
