"""
ClinIA — Clínica Médica Inteligente — Backend FastAPI standalone
...
app = FastAPI(
    title="ClinIA — Clínica Médica Inteligente — Projects API",
    version="1.0.0",
)
...
@app.get("/")
def root():
    return {"service": "ClinIA — Clínica Médica Inteligente backend", "status": "running"}


@app.get("/api/health")
def health():
    return {"status": "healthy", "service": "ClinIA — Clínica Médica Inteligente"}
