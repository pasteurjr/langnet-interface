...
const INPUTS = [{"key": "busca_medicos", "label": "Busca"}];
const KPIS = [{"key": "paciente_nome", "label": "Paciente"}, {"key": "especialidade_nome", "label": "Especialidade"}, {"key": "pre_diagnostico", "label": "Pré-diagnóstico"}];
const IS_DASHBOARD = true;
const HAS_FK = false;

export default function SelecaoDeMedico() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Seleção de Médico</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-005 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
