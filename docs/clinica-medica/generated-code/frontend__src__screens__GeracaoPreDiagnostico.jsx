...
const TASK = "pre_atendimento_cardiologia";
const INPUTS = [{"key": "sinais_vitais", "label": "Sinais Vitais"}, {"key": "outras_observacoes", "label": "Outras Observações"}];
const KPIS = [{"key": "paciente_nome", "label": "Paciente"}, {"key": "queixa_inicial", "label": "Queixa Inicial"}, {"key": "hipoteses", "label": "Hipóteses"}, {"key": "nivel_confianca", "label": "Nível de Confiança"}, {"key": "recomendacao_exames", "label": "Recomendação de Exames"}];
const IS_DASHBOARD = true;
const HAS_FK = false;

export default function GeracaoPreDiagnostico() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Geração de Pré-Diagnóstico</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-004 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
