...
const TASK = "gerir_agenda_medico";
const INPUTS = [{"key": "medico_id", "label": "Médico", "ref": "medicos"}, {"key": "segunda-feira", "label": "Segunda-feira"}, {"key": "terca-feira", "label": "Terça-feira"}, {"key": "quarta-feira", "label": "Quarta-feira"}, {"key": "quinta-feira", "label": "Quinta-feira"}, {"key": "sexta-feira", "label": "Sexta-feira"}, {"key": "sabado", "label": "Sábado"}, {"key": "domingo", "label": "Domingo"}, {"key": "bloqueio_data", "label": "Data do Bloqueio"}, {"key": "bloqueio_motivo", "label": "Motivo do Bloqueio"}];
const KPIS = [];
const IS_DASHBOARD = false;
const HAS_FK = true;

export default function GestaoDeAgendas() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Gestão de Agendas</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-011 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
