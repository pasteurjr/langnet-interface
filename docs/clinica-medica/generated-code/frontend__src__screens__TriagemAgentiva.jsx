...
const TASK = "cadastrar_paciente";
const INPUTS = [{"key": "especialidade_id", "label": "Especialidade", "ref": "especialidades"}];
const KPIS = [{"key": "paciente_nome", "label": "Paciente"}, {"key": "queixa", "label": "Queixa"}, {"key": "pressao", "label": "Pressão"}, {"key": "frequencia_cardiaca", "label": "Frequência Cardíaca"}];
const IS_DASHBOARD = true;
const HAS_FK = true;

export default function TriagemAgentiva() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Triagem Agentiva</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-002 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
