...
const INPUTS = [{"key": "duracao_dor", "label": "Duração da dor?"}, {"key": "localizacao_dor", "label": "Localização exata?"}, {"key": "outros_sintomas", "label": "Há outros sintomas associados?"}];
const KPIS = [{"key": "paciente_nome", "label": "Paciente"}, {"key": "queixa_inicial", "label": "Queixa inicial"}];
const IS_DASHBOARD = true;
const HAS_FK = false;

export default function PreAtendimentoEspecialista() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Pré-atendimento por Especialista</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-003 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
