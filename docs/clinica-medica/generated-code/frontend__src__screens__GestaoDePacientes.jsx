...
const TASK = null;
const INPUTS = [{"key": "nome", "label": "Nome"}, {"key": "cpf", "label": "CPF"}, {"key": "contato", "label": "Telefone"}];
const KPIS = [];
const IS_DASHBOARD = false;
const HAS_FK = false;

export default function GestaoDePacientes() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Gestão de Pacientes</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-015 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
