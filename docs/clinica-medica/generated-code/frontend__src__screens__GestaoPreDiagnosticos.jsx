...
export default function GestaoPreDiagnosticos() {
  ...
  return (
    <div className="max-w-5xl">
      <div className="mb-6 flex items-start justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-800">Gestão de Pré-Diagnósticos</h1>
          <p className="text-xs text-slate-400 mt-0.5">UC-017 · {IS_DASHBOARD ? "painel · atualizado por agente de IA" : "executado por agente de IA"}</p>
        </div>
