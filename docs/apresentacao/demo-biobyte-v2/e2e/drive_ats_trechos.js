// Abre o documento de Agentes & Tarefas e fotografa trechos legíveis dele.
...
(async()=>{
  ...
  await p.goto(`http://localhost:3001/project/${PROJ}/agent-task`,{waitUntil:'domcontentloaded'});
  await sleep(9000);
  await shot(p,'ats-documento-aberto');
