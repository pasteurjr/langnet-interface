...
## Acesso ao sistema
- **Login simples:** o sistema tem cadastro de usuários e exige login com **e-mail e senha** para
  qualquer operação. **Não usar verificação em duas etapas nem código de uso único** — login
  comum, só isso.
- **Usuário:** nome, e-mail, senha, papel (médico, enfermeiro, administrador), ativo.
- **Quem fez o quê:** depois do login, o sistema sabe qual usuário está operando e **grava esse
  usuário em toda ação registrada na auditoria**, sem pedir de novo em cada tela.
